...
This is the discoverable alias for the canonical `apple-container` skill. It ships
the same scripts and references so installing either skill name provides the full
Apple Container Operator workflow.
